...
namespace dblCmpTeamGraphLib
{
    ...
    // using callBackPtr = void (Window::* ) (GLFWwindow* , int , int , int , int );
    ...
    struct QueueFamilyIndices //To Header
    {
    ...
    struct SwapChainSupportDetails //To Header
    {
    ...
    struct UniformBufferObject //To Header
    {
    ...
    static glm::vec3 camera_direction = glm::normalize (glm::vec3 {-1.0f, -1.0f, -1.0f});
    ...
    public:
       ...
       ~Window () {
        ...
        static void key_callback (GLFWwindow* window , int key, int scancode, int action, int mods); // Methods of thw Window

        static void cursor_position_callback (GLFWwindow* window, double xpos, double ypos); // TODO: Maybe problem with static

        static void mouse_button_callback(GLFWwindow* window, int button, int action, int mods) noexcept { // small
    ...
    class HelloTriangleApplication { //Rename it pls and 
    public:
    ...
    private:
        ...
        void mainLoop() {
            ...
            GLFWwindow* window = workSpace.getWindow();
            glfwGetCursorPos(window, &prev_x, &prev_y);
            
            auto key_callback = &workSpace.key_callback;
            auto mouse_button_callback = &workSpace.mouse_button_callback;
        ...
        void recreateSwapChain() {
            ...
            glfwGetFramebufferSize(workSpace.getWindow(), &width, &height);
